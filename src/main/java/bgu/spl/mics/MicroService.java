...
public abstract class MicroService implements Runnable { 
    ...
    private HashMap<Class, Callback> callBackMap; // Not Concurrent - because it belongs to only one Thread.
    protected static AtomicInteger attackSize ;
    /**
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        MessageBusImpl bus = MessageBusImpl.getInstance(); // Bus is a singleton. returns the one and only bus.
        bus.register(this);
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        ...
        bus.register(this); // Bus is a singleton. returns the one and only bus.
    ...
    public boolean isEventCompleted(Event e){
        MessageBusImpl bus=MessageBusImpl.getInstance();
        return bus.isEventcompleted(e);
    }

    public static void setAttackSize(int attackSize) {
        MicroService.attackSize = new AtomicInteger(attackSize);
    }
